...
function ActionCard() {
  return (
    ...
    <a href="/engage/randomId">
      <Card className="flex h-32 w-full cursor-pointer flex-col items-center justify-between overflow-hidden hover:border-primary  sm:w-[820px] sm:flex-row">
        <div>
          <CardHeader>
        ...
        <img
          className="h-40 w-full bg-secondary object-cover sm:w-96"
